...
const tableConfigs = {
  ...
  sklad_gp: { label: '🏭 Склад Готови Детайли', table: 'computed_sklad_gp', readOnlyTab: true, fields: [ { name: 'ID Детайл', type: 'text', readonlyOnEdit: true }, { name: 'Име', type: 'text', readonlyOnEdit: true }, { name: 'Операция', type: 'text', readonlyOnEdit: true }, { name: 'Общо', type: 'number', readonlyOnEdit: true }, { name: 'Запазени', type: 'text', readonlyOnEdit: true }, { name: 'Свободни', type: 'number', readonlyOnEdit: true }, { name: 'Минимално количество/Буфер', type: 'number', def: 0 } ] },
