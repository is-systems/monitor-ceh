...
const tableConfigs = {
  ...
  sklad_gp: { label: '🏭 Склад Цех', table: 'computed_sklad_gp', readOnlyTab: true, fields: [ { name: 'ID Детайл', type: 'text', readonlyOnEdit: true }, { name: 'Име', type: 'text', readonlyOnEdit: true }, { name: 'Операция', type: 'text', readonlyOnEdit: true }, { name: 'Наличност в цеха', type: 'number', readonlyOnEdit: true }, { name: 'Минимално количество/Буфер', type: 'number', def: 0 } ] },
